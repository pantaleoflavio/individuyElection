...
if (!isset($_SESSION['userId'])) {
    ...
    if (isset($_POST['userUpdate'])) {
        ...
        if (!empty($_FILES['image']['name'])) {
            ...
            move_uploaded_file($user_image_temp,  $targetDirectory . '/' . $user_pic);
        } else {
                ...
                <form method="POST" class="bill-detail" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="py-3">
                            ...
                            <img width="150" src="<?php echo $targetDirectory . '/' . $user->user_pic; ?>" alt="" id="image" name="image" class="img-size-sm">
