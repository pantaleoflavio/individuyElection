...
class UserDAOTest extends TestCase
{
    ...
    public function testGetSingleUser()
    {
        ...
        $this->assertEquals($userData['id_user'], $user->id);
    ...
    public function testUpdateSingleUser()
    {
        ...
        $result = $this->userDAO->updateSingleUser($userId, $fullname, $email, $username, $user_image);
    ...
    public function testGetAllUsers()
    {
        ...
        $expectedData = [
            ['id_user' => 1, 'fullname' => 'John Doe', 'email' => 'john@doe.com', 'username' => 'johndoe', 'image_path' => 'john.jpg', 'password' => '$2y$10$mfhvQ3nh.TdyVX00000000dEbbt5Jr0JA/ZZH.000000aZixWrjmy', 'created_at' => '2024-04-10 11:05:09', 'role' => 'user', 'reset_token'=> NULL, 'token_expiry'=> NULL ],
            ['id_user' => 2, 'fullname' => 'Mary Jane', 'email' => 'mary@jane.com', 'username' => 'maryjane', 'image_path' => 'jane.jpg', 'password' => '$2y$10$mfhvQ3nh.TdyVX00000000dEbbt5Jr0JA/ZZH.000000aZixWrjmy', 'created_at' => '2024-04-10 11:06:09', 'role' => 'user', 'reset_token'=> NULL, 'token_expiry'=> NULL ],
        ];
    ...
    public function testSetUserRole()
    {
        ...
        $result = $this->userDAO->setUserRole($userId, $role);
    ...
    public function testGetUserByEmail()
    {
        ...
        $user = $this->userDAO->getSingleUser($userMail);
